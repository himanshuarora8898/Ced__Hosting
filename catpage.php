...
if(isset($_GET['id'])){
    ...
    $obj= new DbCon();
    $obj2=new Product();
   $back= $obj2->cat_dyn($get,$obj->conn);
  foreach($back as $val){
      echo $val['html'];
  }
  $back2=$obj2->cont_dyn($get,$obj->conn);
										...
										<div class="linux-prices">
											<div class="col-md-3 linux-price">
												...
												<div class="linux-bottom">
													...
													<h6>Single Domain</h6>
													<ul>
													<li><strong><?php echo $abc['Webspace']?></strong> Disk Space</li>
													<li><strong><?php echo $abc['Bandwidth']?></strong> Data Transfer</li>
													<li><strong><?php echo $abc['Mailbox']?></strong> Email Accounts</li>
													<li><strong><?php echo $abc['FreeDomain']?> </strong>  Global CDN</li>
